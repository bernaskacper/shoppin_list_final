...
- 📊 **Lista wszystkich paragonów** - chronologiczna historia wydatków
...
- **3 zakładki**: Lista, Moje Listy, Paragony
...
- **Paragony Tab** - nowa zakładka do zarządzania paragonami
- **Receipt Management** - funkcjonalność dodawania/usuwania paragonów
- **Enhanced Export/Import** - wsparcie dla paragonów w backup
